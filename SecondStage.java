...
public class SecondStage extends Stage
{
		...
		endTurn.setOnMouseClicked(new EventHandler<MouseEvent>()
		{
			...
			public void handle(MouseEvent e)
			{
				...
				else
				{
					...
					count.setText("Rolls left " + rollCount);
					turnScore
							.setText("Turn: " + secondStagePlayer.getTurnNum() + "\tScore: " + secondStagePlayer.getScore());
				}
			}
		});
	...
	/******************************************************************************************************
	 * Method to purchase a research facility. Checks if the research facility is already owned, unlocked and if the
	 * player has enough resources. If a research facility is purchased, the player's score is updated and the player's
	 * resources are deducted and a purchase message is displayed in the in game console. If the purchase is
	 * unsuccessful, the corresponding error message is displayed in the in game console.
	 * 
	 * @author Luke Johnson
	 * 
	 * @param tileNum:
	...
	/******************************************************************************************************
	 * Method to purchase a side road. Checks if the side road is already owned, unlocked and if the player has enough
	 * resources. If a side road is purchased, the player's score is updated and the player's resources are deducted and
	 * a purchase message is displayed in the in game console. If the purchase is unsuccessful, the corresponding error
	 * message is displayed in the in game console.
	 * 
	 * @author Luke Johnson
	 * 
	 * @param tileNum:
	...
	/***************************************************************************************************
	 * Method to purchase a main road. Checks if the main road is already owned, unlocked and if the player has enough
	 * resources. If a main road is purchased, the player's score is updated and the player's resources are deducted and
	 * a purchase message is displayed in the in game console. If the purchase is unsuccessful, the corresponding error
	 * message is displayed in the in game console.
	 * 
	 * @author Luke Johnosn
	...
	/**************************************************************************************
	 * Method to purchase a bio-dome. Checks if the bio-dome is already owned, unlocked and if the player has enough
	 * resources. If a bio-dome is purchased, the player's score is updated and the player's resources are deducted and a
	 * purchase message is displayed in the in game console. If the purchase is unsuccessful, the corresponding error
	 * message is displayed in the in game console.
	 * 
	 * @author Luke Johnson
	 * 
	...
	/**************************************************************************************
	 * Method to purchase an astronaut. Checks if the astronaut is already owned, unlocked and if the player has enough
	 * resources. If an astronaut is purchased, the player's score is updated and the player's resources are deducted and
	 * a purchase message is displayed in the in game console. If the purchase is unsuccessful, the corresponding error
	 * message is displayed in the in game console.
	 * 
	 * @author Luke Johnson
	...
	/**********************************************************************************
	 * Method to initialize a player. It takes a player object, initializes their game board and unlocks the first two
	 * purchasable objects on their board, which are the first main road and the first astronaut.
	 * 
	 * @author Luke Johnson
	 * @param player:
	 *           player whose board is being initialized
	 * @return player: initialized player that is returned
	 */
